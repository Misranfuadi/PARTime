...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    <li class="active"><a href="index_master_bank.php"><i class="icon icon-home"></i> <span>Home</span></a> </li>
    <li><a href="tables_bank.php"><i class="icon icon-th"></i> <span>Table Personal Pelayanan</span></a></li>
    ...
    <div class="span12">
      ...
      <div class="widget-box">
          ...
          <div class="widget-content">
              ...
              <div class="stat"><?php echo $pengantri?> / 1000 Pengantri</div>
          </div>
        </div>
    </div>
  </div>
...
<script type="text/javascript">
    $(document).ready(function() {
      setInterval(function () {
        $('#show').load('show_indexmaster_bank.php')
      }, 1000);
    });
  </script>
</script>